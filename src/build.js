...
const NAV = [
 ...
 {id:'people',label:'People',href:'people.html',sub:[
   ['people.html#board','Board &amp; Executive Leadership'],
   ['people.html#advisory','International Advisory Board'],
   ['people-experts.html','Experts &amp; Fellows'],
   ['people.html#young-leaders','Young Leaders']]},
 ...
 {id:'initiatives',label:'Activities',href:'initiatives.html',sub:[
   ['initiative-kigali-knowledge-week.html','Kigali Knowledge Crossroads Week'],
   ['initiative-convenings.html','GPS Dialogues'],
   ['initiative-gcub-assembly.html','GCUB General Assembly'],
   ['initiative-ai-global-south.html','AI for the Global South'],
   ['initiative-reparations.html','Reparations Initiative']]},
 {id:'knowledge',label:'Publications &amp; Multimedia',href:'knowledge-hub.html',sub:[
   ['kh-outlook.html','GPS Outlook'],
   ['kh-journal.html','GPS Journal'],
   ['kh-southplus.html','SouthPlus'],
   ['kh-library.html','Publications'],
   ['kh-media.html','Multimedia']]},
 {id:'news',label:'News &amp; Events',href:'news-events.html',sub:[
   ['news.html','Latest Updates'],
   ['news-impact-stories.html','GPS in Action'],
   ['events.html','Events'],
 ...
 {id:'involved',label:'Get Involved',href:'get-involved.html',sub:[
   ...
   ['get-involved.html#join','Join the Network'],
...
function navHtml(active){
  let items = NAV.map(n=>{
    ...
    const sub = '<div class="sub"><a class="head" href="'+n.href+'">'+n.label+'</a><hr>'+n.sub.map(s=>'<a href="'+s[0]+'">'+s[1]+'</a>').join('')+'</div>';
  ...
  return '<header id="header"><div class="hd-in">'+
    ...
    '<nav class="main" aria-label="Primary"><ul>'+items+
    '<li><a class="donate-btn m-donate" href="donate.html">Donate</a></li></ul></nav>'+
...
'<div><h5>About</h5><ul><li><a href="about-why-gps.html">Why GPS?</a></li><li><a href="about-mission-vision.html">Mission &amp; Vision</a></li><li><a href="about-our-approach.html">Our Approach</a></li><li><a href="about-governance.html">Governance</a></li><li><a href="about-regional-hubs.html">Regional Coordination</a></li><li><a href="impact.html">Impact</a></li></ul></div>'+
...
'<div><h5>Publications &amp; News</h5><ul><li><a href="kh-outlook.html">GPS Outlook</a></li><li><a href="kh-journal.html">GPS Journal</a></li><li><a href="kh-southplus.html">SouthPlus</a></li><li><a href="kh-library.html">Publications</a></li><li><a href="news.html">Latest Updates</a></li><li><a href="events-calendar.html">Calendar</a></li></ul></div>'+
'<div><h5>Get Involved</h5><ul><li><a href="get-involved.html#partner">Partner with GPS</a></li><li><a href="get-involved.html#join">Join the Network</a></li><li><a href="get-involved-opportunities.html">Opportunities</a></li><li><a href="donate.html">Donate</a></li><li><a href="contact.html">Contact Us</a></li><li><a href="mailto:info@gpsouth.org">info@gpsouth.org</a></li></ul></div>'+
...
async function run(V, io){
  ...
  for(const f of files){
    ...
    const body = raw.slice(m[0].length).split('<!--@eco-->').join(eco);
