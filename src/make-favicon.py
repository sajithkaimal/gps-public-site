...
site = Path(r"d:\Projects\gps-public-site")
make(192, 0.34).save(root / "apple-touch-icon.png", optimize=True)
png48 = make(48, 0.36)
png96 = make(96, 0.34)
png32 = make(32, 0.36)
png48.save(root / "favicon-48.png", optimize=True)
png96.save(root / "favicon-96.png", optimize=True)
png32.save(root / "favicon.png", optimize=True)
png48.save(site / "favicon.ico", format="ICO", sizes=[(16, 16), (32, 32), (48, 48)])
print("ok")
